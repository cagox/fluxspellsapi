...
func (school School) Spells() []SpellSummary {
	...
	var sqlStatement := "SELECT ? FROM spells INNER JOIN school_links ON spells.spell_id = school_links.spell_id WHERE school_links.school_id=?"
	var fields := "spells.spell_id, spells.name, spells.summary"
