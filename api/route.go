...
func SetupRoutes() {
	...
	app.Config.Router.HandleFunc("/api/categories/header", listCategoriesHeader).Methods("GET")
	app.Config.Router.HandleFunc("/api/spells", listSpells).Methods("GET")
	app.Config.Router.HandleFunc("/api/schools/{school_id}", viewSchool).Methods("GET")
